...
export default function Loading() {
  return (
    <div className="space-y-grid" aria-busy>
      <div className="h-7 w-40 animate-pulse rounded-input bg-subtle" />
      <div className="flex w-full max-w-[760px] flex-col gap-6">
        <div className="space-y-2">
          <div className="h-3 w-56 animate-pulse rounded-input bg-subtle" />
          <div className="h-8 w-48 animate-pulse rounded-input bg-subtle" />
          <div className="h-5 w-full max-w-[52ch] animate-pulse rounded-input bg-subtle" />
        </div>
        ...
        <div className="h-[104px] animate-pulse rounded-card bg-accent-subtle" />
