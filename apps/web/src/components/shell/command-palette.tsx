  ...
  return (
    <>
      ...
      <button
        ...
        className="surface-ring mx-auto flex h-9 w-[min(420px,100%)] items-center gap-2 rounded-input bg-s2 px-[10px] text-left text-[13px] text-muted transition-micro hover:shadow-[inset_0_0_0_1px_var(--line)] max-narrow:hidden"
      >
