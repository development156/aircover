  ...
  return (
    <div className="relative flex shrink-0 items-center">
      ...
      <button
        ...
        className="surface-ring -ml-px grid h-control w-5 place-items-center rounded-r-control bg-s2 text-muted transition-micro hover:bg-surface-3 hover:text-ink active:scale-[.97] max-narrow:h-11 max-narrow:w-11"
      >
