...
:root {
  ...
  /* Accent TEXT — links, and any orange word on a light surface.
     SOLVED, not picked, and RE-SOLVED for v5 because the ground moved.

     v4 solved this against --surface alone, when --surface and --canvas were
     both #ffffff. v5 moves the page ground to #fafafa and adds a #f2f2f3 well,
     so accent text now has THREE grounds and the darkest one decides.

       #ff6600  on #ffffff 2.94:1 · #fafafa 2.81:1 · #f2f2f3 2.62:1
       #c95100  (v4's value) on the NEW canvas: 4.32:1 — BELOW AA
       #bd4b00  5.04:1 / 4.82:1 / 4.50:1 — clears AA on all three

     Carrying v4's #c95100 forward would have shipped a silent AA regression
     the moment the canvas moved. The brand orange is not weakened, it is
     RATIONED: --p still paints every fill, chip and focus halo. */
  --acc: #bd4b00;
