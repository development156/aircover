# 45 — Product Structure

> **Renumbered 24 August 2026.** This file was written as `docs/35` on the
> `wt-handoff` lane, which never merged. `docs/35` on the trunk is
> `35_Operations.md` — a different document. It is 45 now, and this is the
> only copy.
